...
def UI(stdscr, game_arr):
    ...
    while True:
        ...
        if key == curses.KEY_RIGHT:
            ...
            rules.append(Keepout_Rule(spaces, mask))
            break
    ...
    while True:
        ...
        draw_grid(stdscr, grid, selection_grid, cursor_x, cursor_y)
        stdscr.addstr(GRID_HEIGHT + 1, 0, "Enter the rules of the gameboard by highlighting, then pressing the appropriate combination of keys")
        stdscr.addstr(GRID_HEIGHT + 2, 0, "Arrows move | == - All equal | != - Unequal | +XX - Sum to | <XX - Less Than | >XX - Greater Than | return - enter configuration | q - quit")
        stdscr.refresh()
        ...
        if key1 == curses.KEY_RIGHT:
            ...
            if key2 == ord("="):
                ...
                rules.append(Unequal_Rule(spaces))
                modify_grid(grid, rules)
